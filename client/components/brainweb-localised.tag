  ...
  <script type='coffeescript'>
    ...
    draw = =>
      ...
      for sensor, loc of LOCATIONS
        ...
        ctx.closePath()
        redness = Math.min(@bands.beta[idx]/@bands.total[idx],1)
        greenness = Math.min(@bands.theta[idx]/@bands.total[idx],1)
        blueness = Math.min(@bands.alpha[idx]/@bands.total[idx],1)
